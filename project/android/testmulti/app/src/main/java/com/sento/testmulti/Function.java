...
public class Function {
    ...
    public static String getCounts(Context context, String albumName) {
        ...
        Cursor cursorInternal =
                context.getContentResolver().query(uriInternal, projection, "bucket_display_name=?", new String[]{albumName}, null);
        Cursor cursorExternal =
                context.getContentResolver().query(uriExternal, projection,  "bucket_display_name=?", new String[]{albumName}, null);
